...
While the transformation treats \(y\) as a point in \(\reals\), the ODE treats \(y\) as a differentiable function of \(x\), or in other words an element of once continuously differentiable functions \(\mathcal{C}^1(\reals)\).
While this detail might seem small at this point, the subtlety of this treatment will be essential when developing further theory.
\dots
