...
\keywords{Lie symmetries, Lie point symmetries, First order ODE:s, Gompertz model, Lotka--Volterra predator--prey model, Yildirim--Mackey lactose operon model, Lie algebra}
